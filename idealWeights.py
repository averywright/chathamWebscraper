RedSox9 = input(np.array([20,23,4,4.44,43,1634,1474,191,368,96,4,39,188,10,5,118,346,.250,.307,.400,.707,20,29,.987,28.9,30.0,.323,.403,.454,.857,.342,2.7,10.7,12.1,87.5,31.6,24.3,54.8,17.4,1.21,-0.6,-0.4,-12.4,0]))
Angels9 = input(np.array([27,18,2,4.76,45,1677,1496,214,371,69,5,60,206,26,13,152,413,.248,.321,.421,.742,24,38,.985,28.4,18.0,.288,.316,.548,.864,.305,4.0,14.5,4.0,91.7,48.4,24.2,45.2,24.2,0.85,0.0,0.0,-1.6,1]))
BlueJays9 = input(np.array([23,20,3,3.67,43,1572,1408,158,327,67,2,45,157,16,9,124,342,.232,.301,.379,.680,17,30,.989,27.0,38.1,.205,.256,.322,.578,.300,1.9,34.0,5.8,87.2,33.7,25.8,37.6,29.0,0.60,0.7,0.5,9.1,0]))
Dbacks9 = input(np.array([23,22,4,4.02,45,1654,1460,181,315,64,5,56,170,18,9,166,420,.216,.299,.382,.681,35,37,.978,27.2,11.2,.250,.320,.455,.775,.300,4.0,26.0,8.0,89.4,43.8,25.0,37.5,28.1,0.60,-0.2,-0.2,-1.3,1]))
Dodgers9 = input(np.array([29,14,1,5.49,43,1650,1441,236,355,85,8,48,219,27,5,186,356,.246,.335,.416,.751,21,42,.986,29.7,35.2,.250,.304,.417,.721,.267,3.4,17.5,6.0,89.3,36.9,23.6,39.1,27.3,0.65,0.1,0.1,-0.6,0]))
Athletics9 = input(np.array([19,27,4,3.41,46,1647,1489,157,316,70,7,30,146,30,6,121,402,.212,.277,.329,.606,29,45,.983,28.7,49.1,.216,.274,.273,.546,.275,0.0,19.9,6.3,88.4,36.2,17.3,54.7,23.0,1.23,1.6,0.7,13.4,1]))
Rangers9 = input(np.array([19,23,3,4.07,42,1532,1393,171,311,46,4,45,158,31,9,117,350,.223,.286,.359,.645,26,37,.983,29.3,50.2,.205,.260,.346,.606,.256,3.0,27.4,6.5,87.7,39.4,20.5,47.0,21.2,0.91,0.8,0.5,6.6,0]))
...
def back(x, y, weights, bias):
	...
	weights -= np.reshape(derivativeWeights(x, weights, actual, bias, y),
	                      (45, 1)) * LR
	bias -= derivativeBias(x, weights, actual, bias, y) * LR
...
for i in range(20):
	...
	for j in range(10000):
		...
		weights = weights - np.reshape(derivativeWeights(brewersRuns, weights, actual, bias, 2),
		                               (45, 1)) * LR
		bias -= derivativeBias(brewersRuns, weights, actual, bias, 2) * LR
		...
		weights = weights - np.reshape(derivativeWeights(nationalsRuns, weights, actual, bias, 1),
		                               (45, 1)) * LR
		bias -= derivativeBias(nationalsRuns, weights, actual, bias, 1) * LR
		...
		weights = weights - np.reshape(derivativeWeights(marlinsRuns2, weights, actual, bias, 3),
		                               (45, 1)) * LR
		bias -= derivativeBias(marlinsRuns2, weights, actual, bias, 3) * LR
		...
		weights = weights - np.reshape(derivativeWeights(nationalsRuns3, weights, actual, bias, 2),
		                               (45, 1)) * LR
		bias -= derivativeBias(nationalsRuns3, weights, actual, bias, 2) * LR
		...
		weights = weights - np.reshape(derivativeWeights(marlinsRuns3, weights, actual, bias, 8),
		                               (45, 1)) * LR
		bias -= derivativeBias(marlinsRuns3, weights, actual, bias, 8) * LR
		...
		weights = weights - np.reshape(derivativeWeights(yankeesRuns3, weights, actual, bias, 6),
		                               (45, 1)) * LR
		bias -= derivativeBias(yankeesRuns3, weights, actual, bias, 6) * LR
		...
		weights = weights - np.reshape(derivativeWeights(oriolesRuns3, weights, actual, bias, 2),
		                               (45, 1)) * LR
		bias -= derivativeBias(oriolesRuns3, weights, actual, bias, 2) * LR
		...
		weights = weights - np.reshape(derivativeWeights(marinersRuns3, weights, actual, bias, 2),
		                               (45, 1)) * LR
		bias -= derivativeBias(marinersRuns3, weights, actual, bias, 2) * LR
		...
		weights = weights - np.reshape(derivativeWeights(blueJaysRuns3, weights, actual, bias, 6),
		                               (45, 1)) * LR
		bias -= derivativeBias(blueJaysRuns3, weights, actual, bias, 6) * LR
		...
		weights = weights - np.reshape(derivativeWeights(astrosRuns3, weights, actual, bias, 3),
		                               (45, 1)) * LR
		bias -= derivativeBias(astrosRuns3, weights, actual, bias, 3) * LR
		...
		weights = weights - np.reshape(derivativeWeights(redSoxRuns3, weights, actual, bias, 6),
		                               (45, 1)) * LR
		bias -= derivativeBias(redSoxRuns3, weights, actual, bias, 6) * LR
		...
		weights = weights - np.reshape(derivativeWeights(bravesRuns3, weights, actual, bias, 0),
		                               (45, 1)) * LR
		bias -= derivativeBias(bravesRuns3, weights, actual, bias, 0) * LR
		...
		weights = weights - np.reshape(derivativeWeights(brewersRuns3, weights, actual, bias, 1),
		                               (45, 1)) * LR
		bias -= derivativeBias(brewersRuns3, weights, actual, bias, 1) * LR
		...
		weights = weights - np.reshape(derivativeWeights(angelsRuns3, weights, actual, bias, 4),
		                               (45, 1)) * LR
		bias -= derivativeBias(angelsRuns3, weights, actual, bias, 4) * LR
		...
		weights = weights - np.reshape(derivativeWeights(rangersRuns3, weights, actual, bias, 7),
		                               (45, 1)) * LR
		bias -= derivativeBias(rangersRuns3, weights, actual, bias, 7) * LR
		...
		weights = weights - np.reshape(derivativeWeights(giantsRuns3, weights, actual, bias, 7),
		                               (45, 1)) * LR
		bias -= derivativeBias(giantsRuns3, weights, actual, bias, 7) * LR
	...
	for k in a7:
		counter += 1
		if counter % 2 != 0:
			print(b7[counter - 1] + b7[counter] + str(relu(np.dot(a7[counter - 1], weights) + bias) + relu(np.dot(a7[counter], weights) + bias)))
	...
	if predict:
		...
		for k in a8:
			counter += 1
			if counter % 2 != 0:
				print(b8[counter - 1] + b8[counter] + str(
					relu(np.dot(a8[counter - 1], weights) + bias) + relu(np.dot(a8[counter], weights) + bias)))
				hold.append(relu(np.dot(a8[counter - 1], weights) + bias) + relu(np.dot(a8[counter], weights) + bias))
				
		count = 0
		for l in total:
			count +=1
			total[count-1] += hold[count-1]
